...
required_vars='BORA_API_IMAGE BORA_WEB_IMAGE BORA_RELEASE_TAG BORA_RELEASE_SHA POSTGRES_DB POSTGRES_USER POSTGRES_PASSWORD BORA_PORT BORA_BIND BORA_DOMAIN BORA_TLS_EMAIL DUCKDNS_DOMAIN DUCKDNS_TOKEN'
